namespace WindowsFormsApplication1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(143, 58);
			...
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(143, 136);
			...
			// textBox7
			// 
			this.textBox7.Location = new System.Drawing.Point(143, 162);
			...
			this.label1.Text = "Численность города";
			// 
			// label2
			// 
			...
			this.label2.Text = "Параметр функции T(x)";
			// 
			// label3
			// 
			...
			this.label10.Text = "Искомая доля жителей x";
			// 
			// label11
			// 
			this.label11.AutoSize = true;
			this.label11.Location = new System.Drawing.Point(249, 87);
			this.label11.Name = "label11";
			this.label11.Size = new System.Drawing.Size(93, 13);
			this.label11.TabIndex = 18;
			this.label11.Text = "Количество дней";
			// 
			// Form1
			// 
